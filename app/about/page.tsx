          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card variant="elevated">
              <CardContent className="pt-6">
                ...
                <h3 className="heading-4 mb-3 text-neutral-900">Faith-Centered</h3>
            ...
            <Card variant="elevated">
              <CardContent className="pt-6">
                ...
                <h3 className="heading-4 mb-3 text-neutral-900">Evidence-Based</h3>
                <p className="text-neutral-600">
            ...
            <Card variant="elevated">
              <CardContent className="pt-6">
                ...
                <h3 className="heading-4 mb-3 text-neutral-900">Community-Driven</h3>
                <p className="text-neutral-600">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            <div className="flex gap-6 items-start">
              ...
              <div>
                <h3 className="heading-4 mb-2 text-neutral-900">Integration, Not Separation</h3>
            ...
            <div className="flex gap-6 items-start">
              ...
              <div>
                <h3 className="heading-4 mb-2 text-neutral-900">Proven Strategies</h3>
                <p className="text-neutral-700">
            ...
            <div className="flex gap-6 items-start">
              ...
              <div>
                <h3 className="heading-4 mb-2 text-neutral-900">Community Support</h3>
                <p className="text-neutral-700">
